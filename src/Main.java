...
public class Main {
    ...
    private static void seedSampleUsers() {
        manager.add(new Admin(nextId, "Carlo", "NonotCarlo@liceo.edu.ph"));
        nextId++;

        manager.add(new Teacher(nextId, "Razo", "razz@liceo.edu.ph", "CIT"));
        nextId++;

        manager.add(new Student(nextId, "Millard", "Millard@liceo.edu.ph", "BSIT"));
        nextId++;
